...
--   count_of_instantiated_classes.count_value // 
-- count_of_predicates // Autogenerated from class: count of predicates
--   count_of_predicates.element // 
--   count_of_predicates.count_value // 
-- count_of_subclasses // Autogenerated from class: count of subclasses
--   count_of_subclasses.element // 
--   count_of_subclasses.count_value // 
...
--   rdf_level_summary_statistic.count_value // 

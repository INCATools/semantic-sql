...
--   node_with_two_labels_problem.description // 
...
--   property_used_with_datatype_values_and_objects.description // 
...
--   trailing_whitespace_problem.description // 
...
CREATE VIEW all_problems AS SELECT * FROM node_with_two_labels_problemUNIONSELECT * FROM trailing whitespace problem;

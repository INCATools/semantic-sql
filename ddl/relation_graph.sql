...
--   statements.datatype // 
--   statements.language // 
-- subgraph_edge_by_ancestor // An edge within a subgraph
...
--   subgraph_edge_by_ancestor.ancestor_object // 
--   subgraph_edge_by_ancestor.ancestor_predicate // 
...
CREATE TABLE subgraph_edge_by_ancestor (
	...
	predicate TEXT, 
	object TEXT, 
	ancestor_object TEXT, 
	ancestor_predicate TEXT
);
